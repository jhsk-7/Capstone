...
export default function Navbar() {
  ...
  if (navContext === 'userIn') {
    navItems = [
      { href: "/user/myBikes", label: "My Bikes" }, 
      { href: "/user/appointment/myAppointments", label: "Appointments" }
    ];
  }
  if (navContext === 'adminIn') {
    navItems = [
  ...
  const handleLogout = async () => {
    if(isLoggedIn){
      ...
      try {
        await axios.get("/api/admin/adminAuth/logout", { withCredentials: true });
            ...
            <div className="relative">
              ...
              {open && (
                ...
                >
                  ...
                  {/* Logout */}
                  {(isLoggedIn === true || isAdminLoggedIn === true) && (
                    <button
